...
<p align="center">
  ...
  <img width="240" height="540" alt="home" src="https://github.com/user-attachments/assets/235ea94a-e5f9-464b-a7c0-5ddca72968af" />
  <img width="240" height="540" alt="offer" src="https://github.com/user-attachments/assets/aee58646-f0e9-4355-a061-cadc1a4d14f1" />
...
- **Real-time Cart Management** with add/remove/update
- **Dynamic Product Display** from Firebase Firestore
...
- **Custom Color Scheme** (#EB0029 - Brand Colors)
- **Smooth Animations** and transitions
- **Professional Navigation** with Bottom Nav Bar & Side Drawer
...
- **Carousel Slider** - Banner Carousel
- **Shimmer** - Loading Animations

### Development Tools
- **Flutter Lints** - Code Quality
- **Dart Analysis** - Static Analysis
